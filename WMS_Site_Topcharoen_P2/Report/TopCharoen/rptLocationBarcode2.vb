...
Public Class rptLocationBarcode2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLocationBarcode2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLocationBarcode2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLocationBarcode2 = New rptLocationBarcode2
        rpt.Site = Me.Site
        Return rpt
    End Function
