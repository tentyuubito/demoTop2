...
Public Class rptTransferDocRange
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTransferDocRange.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransferDocRange
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransferDocRange = New rptTransferDocRange
        rpt.Site = Me.Site
        Return rpt
    End Function
