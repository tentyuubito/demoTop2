...
Public Class rptBarcodeBox_KSL
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PackQty() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptBarcodeBox_KSL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcodeBox_KSL = New rptBarcodeBox_KSL
        rpt.Site = Me.Site
        Return rpt
    End Function
