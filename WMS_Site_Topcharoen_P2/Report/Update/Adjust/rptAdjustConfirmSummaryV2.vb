...
Public Class rptAdjustConfirmSummaryV2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAdjustConfirmSummaryV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdjustConfirmSummaryV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdjustConfirmSummaryV2 = New rptAdjustConfirmSummaryV2
        rpt.Site = Me.Site
        Return rpt
    End Function
