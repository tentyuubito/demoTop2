...
Public Class rptSaleOrderSummayV2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSaleOrderSummayV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaleOrderSummayV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaleOrderSummayV2 = New rptSaleOrderSummayV2
        rpt.Site = Me.Site
        Return rpt
    End Function
