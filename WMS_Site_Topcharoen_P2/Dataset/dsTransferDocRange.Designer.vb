...
Partial Public Class dsTransferDocRange
    ...
    Partial Public Class view_rpt_TransferDocRangeDataTable
        ...
        Public Overloads Function Addview_rpt_TransferDocRangeRow( _
                    ...
                    ByVal pic() As Byte) As view_rpt_TransferDocRangeRow
            Dim rowview_rpt_TransferDocRangeRow As view_rpt_TransferDocRangeRow = CType(Me.NewRow,view_rpt_TransferDocRangeRow)
            Dim columnValuesArray() As Object = New Object() {TransportRegion_Id, TransportRegion_Desc, Route_Id, Route_Desc, SubRoute_Id, SubRoute_Desc, Barcode_BAG, Remark, Document_No, Document_Date, Document_Type, Address, Seq, ProductType_Id, ProductType_Desc, Total_Qty, Package_Desc, Str1, Str2, Str3, Str4, Str5, Str6, Str7, Str8, Str9, Str10, Flo1, pic}
    ...
    Partial Public Class view_rpt_TransferDocRangeRow
        ...
        Public Property Flo1() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableview_rpt_TransferDocRange.Flo1Column),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Flo1' in table 'view_rpt_TransferDocRange' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableview_rpt_TransferDocRange.Flo1Column) = value
            End Set
        End Property
        ...
        Public Property pic() As Byte()
            Get
                Try 
                    Return CType(Me(Me.tableview_rpt_TransferDocRange.picColumn),Byte())
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'pic' in table 'view_rpt_TransferDocRange' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableview_rpt_TransferDocRange.picColumn) = value
            End Set
        End Property
        ...
        Public Function IsFlo1Null() As Boolean
            Return Me.IsNull(Me.tableview_rpt_TransferDocRange.Flo1Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetFlo1Null()
            Me(Me.tableview_rpt_TransferDocRange.Flo1Column) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IspicNull() As Boolean
            Return Me.IsNull(Me.tableview_rpt_TransferDocRange.picColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetpicNull()
            Me(Me.tableview_rpt_TransferDocRange.picColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
