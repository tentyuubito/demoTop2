...
Public Class bl_Import_SO : Inherits DBType_SQLServer
...
#Region "   Import Excel   "
    ...
    Public Function LoadWorkSheet(ByVal pstrFileName As String) As DataTable
        Try
            ...
            strConnString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & pstrFileName & ";Extended Properties=""Excel 12.0;Xml;HDR=YES"";"
    ...
    Public Function GetSKU_Index(ByVal pstrModel As String, ByVal pstrCustomer As String) As String
        Try
            ...
            strSQL &= " FROM ms_SKU "
            strSQL &= " WHERE SKU_Id = '" & pstrModel & "' and Status_id <> -1"
    ...
    Public Function GetSaleOrder(ByVal pstrCustomerOrderNo As String, ByVal pstrCustomerIndex As String) As DataTable
        Try
            ...
            strSQL = " select * from tb_Salesorder where status <> -1 and Salesorder_No = '" & pstrCustomerOrderNo & "' and Customer_Index = '" & pstrCustomerIndex & "' "
...
#Region "Import Text File"
    Public Function SetHeader_TextFile(ByVal processId As String) As DataTable
        Try

            Dim strSQL As String = "" 'SalesOrder_Index,SalesOrder_No
            strSQL = " select Field_name from Config_Import_Text where Process_ID = " & processId & " order by Tab_Index"
