            ...
            If drGenTag.Length > 0 Then
                ...
                If RowError = -1 Then ' Check Validate -1 = Okay
                    Select Case Me.cboQtyPerTagManual.SelectedIndex
                        Case 0 ' 1 : 1
                            ...
                            For Each DrOrderItem As DataRow In drGenTag
                                ...
                                Dim frmPopup As New popupScanLPN
                                frmPopup.ShowDialog()

                                otb_TAG.TAG_No = IIf(Not String.IsNullOrEmpty(frmPopup.strLPN), frmPopup.strLPN, objAutoNumber.getSys_Value("TAG_NO")) ' objAutoNumber.getSys_Value("TAG_NO")
                        ...
                        Case 1 '1 : M
                            ...
                            Dim frm As New frmTag_Add_One_to_M
                            ...
                            If frm.Confirm Then
                                For Each DrOrderItem As DataRow In frm.DataSource.Rows
                                    ...
                                    otb_TAG.TAG_Index = objDBTempIndex.getSys_Value("TAG_Index")
                                    otb_TAG.TAG_No = IIf(Not String.IsNullOrEmpty(DrOrderItem("LPN_NO")), DrOrderItem("LPN_NO"), objAutoNumber.getSys_Value("TAG_NO")) ' objAutoNumber.getSys_Value("TAG_NO")
                                    objItemCollection.Add(otb_TAG)
                                Next
                            Else
                                Exit Sub
                        ...
                        Case 2
                            Dim frm As New frmPopUpTagDuplicate("", _Order_Index) ' WMS_STD_INB_Receive.frmPopUpTagDuplicate("", _Order_Index)
                            frm.ShowDialog()
                    ...
                    If objItemCollection.Count > 0 Then
                        ...
                        For Each itemObj As tb_TAG In objItemCollection
                            objPutawaySuggestLocation.Suggest_Location(itemObj.TAG_Index, itemObj.Sku_Index, "", itemObj.ItemStatus_Index, "", itemObj.Customer_Index, itemObj.Qty, itemObj.Weight, itemObj.Volume)
                        Next
    ...
    Private Sub btnSaveTag_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaveTag.Click
        Try
            ...
            If ListTag_Index.Count > 0 Then
                Dim frm As New frmPutawayWithTAG 'WMS_STD_INB_Receive.frmPutawayWithTAG
        ...
        Try
            ...
            Try
                ...
                If Lstr.Count > 0 Then
                    ...
                    strTagLPN = String.Join("','", Lstr.ToArray)
                    strWherePlus &= "  TAG_Index in ('" & strTagLPN & "')"
                    ...
                    Dim oReport As New WMS_STD_INB_Report.Loading_Report(Report_Name, strWherePlus)
