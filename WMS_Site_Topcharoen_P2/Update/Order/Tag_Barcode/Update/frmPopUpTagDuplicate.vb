...
Public Class frmPopUpTagDuplicate
    ...
    Public Sub New(ByVal Tag_No_New As String, ByVal Order_Index_new As String)
        MyBase.New()
        InitializeComponent()
        _Tag_No = Tag_No_New
    ...
    Private Sub frmPopUpTagDuplicate_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If Me._Tag_No = "" Then
    ...
    Private Sub btn_OKManualTag_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_OKManualTag.Click
        ...
        Try
            ...
            If Me._Tag_No = "" Then
                ...
                frmPopup.ShowDialog()
                Me._Tag_No = IIf(Not String.IsNullOrEmpty(frmPopup.strLPN), frmPopup.strLPN, objAutoNumber.getSys_Value("TAG_NO")) ' objAutoNumber.getSys_Value("TAG_NO") ' objAutoNumber.getSys_Value("TAG_NO")
            End If
