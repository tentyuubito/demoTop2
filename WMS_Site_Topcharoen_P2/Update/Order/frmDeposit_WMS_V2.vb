...
#Region "   Property   "
    ...
    Public Property strDocumentType() As String
        Get
    ...
    Private Sub getOrderHeader(ByVal Order_Index As String)
        ...
        Try
            ...
            If objDT.Rows.Count > 0 Then
                ...
                If objDT.Rows(0).Item("PO_No").ToString = "" Then
                    txtPlanReceive.Text = Me.DocumentPlan_No
                Else
        ...
        Try
            ...
            For i As Integer = 0 To objDT.Rows.Count - 1
                With Me.grdOrderItem
                    ...
                    .Rows(i).Cells("col_Qty2").Value = objDT.Rows(i).Item("Plan_Qty")  'FormatNumber(objDT.Rows(i).Item("Qty"), 2)
            ...
            txtPlanReceive.Enabled = False
            btnPo_Item.Enabled = False
            DataGridClick = True
            ' *************************************
...
#End Region
    ...
    Private Sub frmDeposit_WMS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.txtPlanReceive.Enabled = True
            Me.btnPo_Item.Enabled = True
    ...
    Sub GetPOItem()
        ...
        Try
            ...
            If objDT.Rows.Count > 0 Then
                ...
                '''' ******************************************************************************************
                If objDT.Rows(0).Item("PurchaseOrder_No").ToString <> "" Then
                    Dim oDT As DataTable = New DataTable
                    Dim obj_GetDocType As New OrderTransaction(OrderTransaction.enuOperation_Type.SEARCH)
                    obj_GetDocType.GetDocumentType_Ref(objDT.Rows(0).Item("PurchaseOrder_No").ToString) ''Me.strDocumentType, 
                    oDT = obj_GetDocType.DataTable
                ...
                For Each odr As DataRow In objDT.Rows
                    ...
                    grdOrderItem.Rows(i).Cells("col_Qty").Value = 0
                    grdOrderItem.Rows(i).Cells("col_Qty2").Value = odr("Total_Qty") / odr("Ratio")
            ...
            Me.btnPo_Item.Enabled = False
            Me.txtPlanReceive.Enabled = False
...
#End Region
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        Try
            ...
            Dim objDB As New OrderTransaction(OrderTransaction.enuOperation_Type.DELETE)
            For Irow As Integer = 0 To grdOrderItem.Rows.Count - 2
                If objDB.isItemTAG(Me.grdOrderItem.Rows(Irow).Cells("col_DocumentPlanItem_Index").Value) Or objDB.isItemSerial(Me.grdOrderItem.Rows(Irow).Cells("col_DocumentPlanItem_Index").Value) Then ''col_OrderItem_Index
        ...
        Try
            ...
            Select Case _USE_PUTAWAY_BY_TAG
                Case 0
                    ...
                    frm.ShowDialog()
                Case 1
                    Dim frm As New frmTag_Main_V3 '  frmTag_Main_V4 'frmTag_Main_V3 'frmTag_Main
                    frm.Icon = Me.Icon
                    frm.Order_Index = Me._Order_Index
                    frm.ShowDialog()
                    Select Case objStatus
