...
#End Region
    ...
    Private Sub txtSaleOrder_NoSeach_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSaleOrder_NoSeach.KeyDown
        ...
        Try
            ...
            Select Case Me.cboDocTrip.SelectedIndex
                ...
                Case 2
                    Dim obj As New ML_TransportBarcode 'get class
                    Dim DtResponse As New DataTable
                    DtResponse = obj.getTransBarcode(txtSaleOrder_NoSeach.Text) 'get function
                    ...
                    Dim strWhere As String = ""
                    Dim ss As String = ""
                    For Each dtrow As DataRow In DtResponse.Rows
                        strWhere &= "'" & dtrow.Item("SalesOrder_index") & "',"
                        ss = strWhere.Remove(strWhere.Length - 1)
                    Next
                    strSearch = " and SalesOrder_Index in " & "(" & ss & ")"
    ...
    Private Sub txtSaleOrder_NoSeach_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtSaleOrder_NoSeach.TextChanged
