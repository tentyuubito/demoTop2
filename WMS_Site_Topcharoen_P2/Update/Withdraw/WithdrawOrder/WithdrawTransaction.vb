...
#Region "SAVE Withdraw "
    ...
    Public Function SaveWithdrawConfirm(ByVal Withdraw_Index As String, Optional ByVal Transaction As SqlClient.SqlTransaction = Nothing) As String
        ...
        Try
            ...
            oAudit_Log.Document_No = DS.Tables("tbl").Rows(0).Item("Withdraw_No").ToString
...
#End Region
    ...
    Public Function GetWithdrawbyCustomer(ByVal pWithdraw_No As String, ByVal Customer_Shipping_Location_Id As String) As DataTable
        Try
            Dim SQL As String = ""


            SQL = "  SELECT top 100 * FROM VIEW_WithDrawByCustomer "
            SQL &= " WHERE 1=1 AND Withdraw_No = @pWithdraw_No AND Customer_Shipping_Location_Id = @Customer_Shipping_Location_Id "

            With SQLServerCommand.Parameters
                .Clear()
                .Add("@pWithdraw_No", SqlDbType.VarChar).Value = pWithdraw_No
                .Add("@Customer_Shipping_Location_Id", SqlDbType.VarChar).Value = Customer_Shipping_Location_Id
            End With
    ...
    Public Function GetWithdraw_Serial(ByVal Serial As String) As String
        Try
            Dim SQL As String = ""
            Dim result As String
            SQL = "  SELECT Barcode FROM tb_SalesOrderPacking_Barcode "
            SQL &= " WHERE Barcode = @Barcode "

            With SQLServerCommand.Parameters
                .Clear()
                .Add("@Barcode", SqlDbType.VarChar).Value = Serial
            End With

            result = DBExeQuery_Scalar(SQL)
