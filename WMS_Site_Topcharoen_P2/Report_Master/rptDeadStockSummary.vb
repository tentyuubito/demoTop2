...
Public Class rptDeadStockSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDeadStockSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeadStockSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeadStockSummary = New rptDeadStockSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
