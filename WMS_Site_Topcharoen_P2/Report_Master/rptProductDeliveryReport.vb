...
Public Class rptProductDeliveryReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProductDeliveryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ProductType() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptProductDeliveryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProductDeliveryReport = New rptProductDeliveryReport
        rpt.Site = Me.Site
        Return rpt
    End Function
