...
Public Class rptOrderSummary_Eng
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptOrderSummary_Eng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrderSummary_Eng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrderSummary_Eng = New rptOrderSummary_Eng
        rpt.Site = Me.Site
        Return rpt
    End Function
