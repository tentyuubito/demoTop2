...
Public Class rptPOPendingReceive
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPOPendingReceive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPOPendingReceive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPOPendingReceive = New rptPOPendingReceive
        rpt.Site = Me.Site
        Return rpt
    End Function
