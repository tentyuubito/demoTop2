...
Public Class rptWithdrawSummary_Eng
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWithdrawSummary_Eng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWithdrawSummary_Eng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWithdrawSummary_Eng = New rptWithdrawSummary_Eng
        rpt.Site = Me.Site
        Return rpt
    End Function
