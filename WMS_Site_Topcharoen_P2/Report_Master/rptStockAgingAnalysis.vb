...
Public Class rptStockAgingAnalysis
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockAgingAnalysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockAgingAnalysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockAgingAnalysis = New rptStockAgingAnalysis
        rpt.Site = Me.Site
        Return rpt
    End Function
