...
Public Class rptReservationPending
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReservationPending.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReservationPending
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReservationPending = New rptReservationPending
        rpt.Site = Me.Site
        Return rpt
    End Function
