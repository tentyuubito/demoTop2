...
Public Class rptRecGroupBySKU_Eng
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRecGroupBySKU_Eng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecGroupBySKU_Eng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecGroupBySKU_Eng = New rptRecGroupBySKU_Eng
        rpt.Site = Me.Site
        Return rpt
    End Function
