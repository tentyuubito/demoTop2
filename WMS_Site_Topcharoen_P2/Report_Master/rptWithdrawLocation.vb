...
Public Class rptWithdrawLocation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWithdrawLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWithdrawLocation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWithdrawLocation = New rptWithdrawLocation
        rpt.Site = Me.Site
        Return rpt
    End Function
