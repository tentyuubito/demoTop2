...
Public Class rptPieSpaceUsedByProductType
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPieSpaceUsedByProductType.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPieSpaceUsedByProductType
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPieSpaceUsedByProductType = New rptPieSpaceUsedByProductType
        rpt.Site = Me.Site
        Return rpt
    End Function
