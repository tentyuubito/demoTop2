...
Public Class rptMounth_Sku_Weight
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMounth_Sku_Weight.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMounth_Sku_Weight
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMounth_Sku_Weight = New rptMounth_Sku_Weight
        rpt.Site = Me.Site
        Return rpt
    End Function
