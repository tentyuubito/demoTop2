...
Public Class rptInventory_Aging_Eng
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventory_Aging_Eng.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventory_Aging_Eng
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventory_Aging_Eng = New rptInventory_Aging_Eng
        rpt.Site = Me.Site
        Return rpt
    End Function
