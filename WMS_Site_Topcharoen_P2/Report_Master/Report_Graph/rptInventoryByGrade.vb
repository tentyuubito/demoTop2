...
Public Class rptInventoryByGrade
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventoryByGrade.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventoryByGrade
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventoryByGrade = New rptInventoryByGrade
        rpt.Site = Me.Site
        Return rpt
    End Function
