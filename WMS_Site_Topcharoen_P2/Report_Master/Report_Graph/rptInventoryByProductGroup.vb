...
Public Class rptInventoryByProductGroup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventoryByProductGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventoryByProductGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventoryByProductGroup = New rptInventoryByProductGroup
        rpt.Site = Me.Site
        Return rpt
    End Function
