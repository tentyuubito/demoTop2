...
Public Class rptPickingPerformance
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPickingPerformance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPickingPerformance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPickingPerformance = New rptPickingPerformance
        rpt.Site = Me.Site
        Return rpt
    End Function
