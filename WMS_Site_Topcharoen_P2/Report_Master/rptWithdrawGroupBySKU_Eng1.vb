...
Public Class rptWithdrawGroupBySKU_Eng1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWithdrawGroupBySKU_Eng1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWithdrawGroupBySKU_Eng1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWithdrawGroupBySKU_Eng1 = New rptWithdrawGroupBySKU_Eng1
        rpt.Site = Me.Site
        Return rpt
    End Function
