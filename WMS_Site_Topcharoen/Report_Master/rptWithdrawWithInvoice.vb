...
Public Class rptWithdrawWithInvoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWithdrawWithInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWithdrawWithInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWithdrawWithInvoice = New rptWithdrawWithInvoice
        rpt.Site = Me.Site
        Return rpt
    End Function
