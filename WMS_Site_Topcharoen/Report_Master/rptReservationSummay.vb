...
Public Class rptReservationSummay
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReservationSummay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReservationSummay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReservationSummay = New rptReservationSummay
        rpt.Site = Me.Site
        Return rpt
    End Function
