...
Public Class rptCustomer_Shipping
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCustomer_Shipping.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prHeader_Report() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCustomer_Shipping
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomer_Shipping = New rptCustomer_Shipping
        rpt.Site = Me.Site
        Return rpt
    End Function
