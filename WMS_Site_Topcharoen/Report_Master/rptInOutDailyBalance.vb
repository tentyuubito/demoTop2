...
Public Class rptInOutDailyBalance
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInOutDailyBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInOutDailyBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInOutDailyBalance = New rptInOutDailyBalance
        rpt.Site = Me.Site
        Return rpt
    End Function
