...
Public Class rptRecGroupByProduct
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRecGroupByProduct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecGroupByProduct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecGroupByProduct = New rptRecGroupByProduct
        rpt.Site = Me.Site
        Return rpt
    End Function
