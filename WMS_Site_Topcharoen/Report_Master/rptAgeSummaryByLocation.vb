...
Public Class rptAgeSummaryByLocation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAgeSummaryByLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAgeSummaryByLocation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAgeSummaryByLocation = New rptAgeSummaryByLocation
        rpt.Site = Me.Site
        Return rpt
    End Function
