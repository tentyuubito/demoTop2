...
Public Class rptPurchaseOrderSummay
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPurchaseOrderSummay.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseOrderSummay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseOrderSummay = New rptPurchaseOrderSummay
        rpt.Site = Me.Site
        Return rpt
    End Function
