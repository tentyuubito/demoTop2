...
Public Class rptWithdrawGroupBySKU
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWithdrawGroupBySKU.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SKUName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptWithdrawGroupBySKU
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWithdrawGroupBySKU = New rptWithdrawGroupBySKU
        rpt.Site = Me.Site
        Return rpt
    End Function
