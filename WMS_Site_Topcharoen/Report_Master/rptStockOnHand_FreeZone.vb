...
Public Class rptStockOnHand_FreeZone
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockOnHand_FreeZone.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockOnHand_FreeZone
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockOnHand_FreeZone = New rptStockOnHand_FreeZone
        rpt.Site = Me.Site
        Return rpt
    End Function
