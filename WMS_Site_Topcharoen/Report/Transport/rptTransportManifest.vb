...
Public Class rptTransportManifest
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTransportManifest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransportManifest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransportManifest = New rptTransportManifest
        rpt.Site = Me.Site
        Return rpt
    End Function
