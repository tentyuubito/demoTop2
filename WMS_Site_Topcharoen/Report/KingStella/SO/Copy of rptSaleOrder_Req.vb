...
Public Class Copy_of_rptSaleOrder_Req
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of rptSaleOrder_Req.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_rptSaleOrder_Req
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_rptSaleOrder_Req = New Copy_of_rptSaleOrder_Req
        rpt.Site = Me.Site
        Return rpt
    End Function
