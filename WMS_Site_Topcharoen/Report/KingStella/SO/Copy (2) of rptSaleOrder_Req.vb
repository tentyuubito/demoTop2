...
Public Class Copy_2_of_rptSaleOrder_Req
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy (2) of rptSaleOrder_Req.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SalesOrder_No() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCopy_2_of_rptSaleOrder_Req
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_2_of_rptSaleOrder_Req = New Copy_2_of_rptSaleOrder_Req
        rpt.Site = Me.Site
        Return rpt
    End Function
