...
Public Class rptWithdrawGroupByProductV2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWithdrawGroupByProductV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWithdrawGroupByProductV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWithdrawGroupByProductV2 = New rptWithdrawGroupByProductV2
        rpt.Site = Me.Site
        Return rpt
    End Function
