...
Public Class Copy_of_rptPo_Scan2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of rptPo_Scan2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_rptPo_Scan2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_rptPo_Scan2 = New Copy_of_rptPo_Scan2
        rpt.Site = Me.Site
        Return rpt
    End Function
