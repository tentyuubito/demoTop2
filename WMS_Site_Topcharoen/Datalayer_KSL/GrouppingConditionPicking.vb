        ...
        Try
            ...
            For Each drAutoPicking As DataRow In dtSalesOrderGroup.Rows
                ...
                With drAutoPicking
                    ...
                    objPicking = New WMS_Site_TopCharoen.PICKING(TypePicking, .Item("Sku_Index").ToString, .Item("Package_Index").ToString, Picking_Qty, xWhere.ToString, DocumentType_Index)
