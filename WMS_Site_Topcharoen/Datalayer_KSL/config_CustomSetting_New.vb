...
Public Class config_CustomSetting_New : Inherits DBType_SQLServer
    ...
    Public Function GetOther_Where(ByVal Column_PickingType As String, ByVal strCondition As String, _
          ByVal _Connection As SqlClient.SqlConnection, ByVal _myTrans As SqlClient.SqlTransaction) As String
