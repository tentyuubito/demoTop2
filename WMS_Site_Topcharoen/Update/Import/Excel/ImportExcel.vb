...
Public Class ImportExcel
    ...
    Private Const IMPORT_SO_PROCEDURE_NAME As String = "sp_Imports_SalesOrder"
    Private Const IMPORT_SO_TABLE_NAME As String = "_Prepare_Imports_SalesOrder"
    ...
    Public Sub ImportSalesOrder(ByVal DataExcel As DataTable, ByVal DocumentTypeIndex As String, ByVal SAO_Type As String)
        DBconnect()
        ...
        Try
            ...
            With Data.Columns
                ...
                With .Add("Row_Seq", GetType(Integer))
                    .Expression = 0
                    .SetOrdinal(5)
                End With
            ...
            Using MyBulkCopy As New SqlClient.SqlBulkCopy(Transaction.Connection, SqlClient.SqlBulkCopyOptions.Default, Transaction)
                With MyBulkCopy
                    With .ColumnMappings
                        .Clear()

                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Kasco_GuID", "GuID"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Kasco_GuID_Log", "GuID_Log"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Kasco_Status", "Status"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Kasco_Message", "Message"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("IsHeader", "IsHeader"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Row_Seq", "Seq"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Add_Date", "Add_Date"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("SalesOrder_No", "24"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("SalesOrder_Date", "1"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Expected_Delivery_Date", "7"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("UrgentJob", "23"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Customer_Shipping_ID", "25"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Customer_Shipping_Location_ID", "3"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("TransportRegion", "6"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Remark", "20"))

                        .Add(New SqlClient.SqlBulkCopyColumnMapping("SKU_Id", "22"))
                        .Add(New SqlClient.SqlBulkCopyColumnMapping("Qty", "18"))

                        .Add(New SqlClient.SqlBulkCopyColumnMapping("ตาถนัด", "33"))
                    End With
            ...
            With SQLServerCommand.Parameters
                ...
                .Add("@SO_Type", SqlDbType.VarChar).Value = SAO_Type
                .Add("@Add_By", SqlDbType.VarChar).Value = WV_UserName
            End With

            Dim QueryProcedure As String = String.Format(" EXEC {0} @GuID, @SO_Type, @Add_By ", IMPORT_SO_PROCEDURE_NAME)
            'Dim Result As String = DBExeQuery_Scalar(QueryProcedure, Transaction.Connection, Transaction)
