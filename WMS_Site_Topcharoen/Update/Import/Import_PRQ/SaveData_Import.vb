...
Public Class SaveData_Import : Inherits DBType_SQLServer
...
#End Region
    ...
    Public Function Insert_PO(ByVal _dtPOHeader As DataTable, ByVal _dtPODetail As DataTable, Optional ByVal Status As Integer = 2) As Boolean
                ...
                For iData As Integer = 0 To CountDtTemp - 1
                    If iData = 0 Then
                        If _DtTemp.Rows(iRows).Item(iData).ToString = "" Then
                            strSQL &= "''"
                        Else
                            strSQL &= "'" & _DtTemp.Rows(iRows).Item(iData).ToString.Replace("'", "") & "'"
                        End If
                    Else
                        If _DtTemp.Rows(iRows).Item(iData).ToString = "" Then
                            strSQL &= ",''"
