...
Public Class clsImportSO : Inherits DBType_SQLServer
...
#Region " variables"
    ...
    Private _OutputDtHeader As New DataTable
    Private _OutputDtDetail As New DataTable
...
#Region "  Property"
    ...
    Public Property GUid() As String
        ...
        End Set
    End Property
    Private _NoSKU As Boolean
    Public Property NoSKU() As Boolean
        Get
            Return _NoSKU
        End Get
        ...
        End Set
    End Property
    Private _NoPackage As Boolean
    Public Property NoPackage() As Boolean
        Get
            Return _NoPackage
        End Get
        Set(ByVal value As Boolean)
        ...
        End Set
    End Property
    Private _SkuID_Error As String
    Public Property SkuID_Error() As String
        Get
            Return _SkuID_Error
        End Get
        Set(ByVal value As String)
...
#End Region
    ...
    Public Function ReadData() As Boolean
        ...
        Try
            ...
            _dtConfig = fnGetConfigImport(_File_Prefix, _Process_ID, 1)
            ...
            For i As Integer = 0 To _DtTemp.Rows.Count - 1
                    ...
                    If _dtHeader.Rows.Count > 0 Then
                        ...
                        If drChkDupe.Length <= 0 Then
                            ...
                            Else
                                ...
                                _SalesOrder_No = DrHeader("SalesOrder_No")
                                blChkHaveSoNo = False
                            End If
                        Else
                ...
                If blChkHaveSoNo = False Then
                    ...
                    If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "SalesOrder_Date") Then
                        ...
                        If Not ChkNull_SalesOrder_Date = "" Then
                    ...
                    If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Carrier_ID") = 1 Then
                        ChkDupe_Carrier_Index = objkascoCLB.check_Dupe("ms_Carrier", "Carrier_Index", "Carrier_Index = '" & _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Carrier_Index")) & "' AND  status_id <> -1")
                    ...
                    If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Delivery_Date") Then
                        ...
                        If Not ChkNull_Delivery_Date = "" Then
                    ...
                    If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Customer_Shipping_Id") Then
                        ChkDupe_Customer_Shipping_Index = objkascoCLB.check_Dupe("ms_Customer_Shipping", "Customer_Shipping_Index", "Str1 = '" & _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Id")) & "' AND  status_id <> -1")
                        ...
                        Else
                            Dim Company_Name = _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Name"))
                            Dim ObjShipping As New ms_AutoCustomer_Shipping(ms_Customer_Shipping.enuOperation_Type.ADDNEW)
                            Dim ChkDupe_Customer_Shipping_Id = _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Id"))
                            Dim Address = _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Location_Address1"))
                    ...
                    If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Customer_Shipping_Location_Id") Then
                        ChkDupe_Customer_Shipping_Location_Index = objkascoCLB.check_Dupe("ms_Customer_Shipping_Location", "Customer_Shipping_Location_Index", "Customer_Shipping_Location_Id = '" & _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Location_Id")) & "' AND  status_id <> -1 and Customer_Shipping_Index=(select top 1 Customer_Shipping_Index from ms_Customer_Shipping where Customer_Shipping_Index='" & DrHeader("Customer_Shipping_Index") & "' and status_id <> -1) ")
                        ...
                        Else
                            Dim Shipping_Location_Name = _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Name"))
                            Dim Shipping_Location_Address = _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Shipping_Location_Address1"))
                            ...
                            ChkDupe_Customer_Shipping_Location_Index = ObjShippingLocation.InsertCustomer_Shipping_Location(Customer_Shipping_Location_Id, Shipping_Location_Name, Shipping_Location_Address, ChkDupe_Customer_Shipping_Index)
                            If ChkDupe_Customer_Shipping_Location_Index = "" Then
                                'Update_Prepare_Imports()
                                'Return False
                            Else
                                DrHeader("Customer_Shipping_Location_Index") = ChkDupe_Customer_Shipping_Location_Index
                    ...
                    If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Customer_Id") Then
                        ...
                        ChkDupe_Customer_Index = objkascoCLB.check_Dupe("ms_Customer", "Customer_Index", "Customer_Id= '" & _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Customer_Id")) & "' AND  status_id <> -1")
                        If Not ChkDupe_Customer_Index Is Nothing OrElse Not ChkDupe_Customer_Index = "" Then
                            DrHeader("Customer_Index") = ChkDupe_Customer_Index
                        Else
                ...
                If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Sku_Id") Then
                    ...
                    Dim sku_Name As String = _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Sku_Name"))
                    If skuId_where Is Nothing OrElse skuId_where = "" Then

                        Continue For
                    End If
                    DtSku = objkascoCLB.check_returnDataTable("ms_SKU", "*", " Sku_Id ='" & skuId_where & "' AND status_id <> -1")
                    ...
                    Else
                        _NoSKU = True
                        SkuID_Error += skuId_where + vbNewLine
                        Continue For
                    End If
                Else
                    ' Continue For
                ...
                If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Package_Id") Then
                    ...
                    Else
                        _NoPackage = True
                        SkuID_Error += _DtTemp.Rows(i)(KascoCLB.Import.get_TabIndex(_dtConfig, strField_Type, "Sku_Id")) + " " + vbNewLine
                        Continue For
                    End If
                Else
                    'Default value
                ...
                If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Weight") Then
                    ...
                    Else
                        ...
                        '    DrDetail("Weight") = 0
                        'End If
                        UnitWeight_Index = DtSkuPKRatio.Rows(0).Item("Weight")
                        If Not UnitWeight_Index Is Nothing And UnitWeight_Index <> "" Then
                            DrDetail("Weight") = FormatNumber((CDbl(UnitWeight_Index) * DrDetail("Qty")), 4)
                        Else
                            DrDetail("Weight") = 0
                        End If
                ...
                If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "Volume") Then
                    ...
                    Else
                        ...
                        'End If
                        If IsNumeric(DtSkuPKRatio.Rows(0).Item("Volume")) Then
                            DrDetail("Volume") = FormatNumber(DtSkuPKRatio.Rows(0).Item("Volume") * DrDetail("Qty"), 4)
                        End If
                    End If
                Else
                    'If IsNumeric(DtSku.Rows(0).Item("Unit_Volume")) Then
                ...
                If KascoCLB.Import.check_Isuse(_dtConfig, strField_Type, "UnitPrice") Then
                    ...
                    If Not ChkNull_UnitPrice Is Nothing OrElse Not ChkNull_UnitPrice = "" Then
                        If ChkNull_UnitPrice = "" Then
                            DrDetail("UnitPrice") = 0
                        Else
            ...
            Next
            _OutputDtHeader = _dtHeader
            Me._OutputDtDetail = _dtDetail
            ' If Insert_SO() = True Then
            Return True
            'End If
        ...
        Try
            ...
            If drArrHeader.Length > 0 Then
                ...
                With SQLServerCommand
                    ...
                    .Parameters.Add("@Process_Id", SqlDbType.Int, 4).Value = _Process_ID 'drHeader("Process_Id")
                ...
                If drArrItem.Length > 0 Then
                    For j As Integer = 0 To drArrItem.Length - 1
                        ...
                        With SQLServerCommand
                            ...
                            If drDetail("Amount").ToString <> "0" Then
                                .Parameters.Add("@Amount", SqlDbType.Float, 8).Value = drDetail("Amount").ToString
                            Else
                                .Parameters.Add("@Amount", SqlDbType.Float, 8).Value = drDetail("Qty") * drDetail("UnitPrice")
                            End If
                            ...
                            If drDetail("Total_Amt").ToString <> 0 Then
                                .Parameters.Add("@Total_Amt", SqlDbType.Float, 8).Value = drDetail("Total_Amt").ToString
                            Else
                                .Parameters.Add("@Total_Amt", SqlDbType.Float, 8).Value = drDetail("Qty") * drDetail("UnitPrice")
                            End If
                ...
                strSQL &= " str4 = (Select top 1 isnull(tel,'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
                strSQL &= " ,str9 = (Select top 1 isnull([Address],'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
                strSQL &= " ,Time_DocTripConfirmed  =  null"
                strSQL &= " ,Time_DeliveryToDestination  =  null"
                strSQL &= " ,Time_DocReturnedToDC  =  null"
                strSQL &= " ,Time_DocReturnedToSource  =  null"
                strSQL &= " ,Time_DocReturnedToOwner  =  null"
                strSQL &= " ,Time_DocConfirmedByOwner  =  null"
                strSQL &= " ,Amount  = (Select Sum(Amount)  from tb_SalesOrderItem where SalesOrder_Index  ='" & _SalesOrder_Index & "')"
                strSQL &= " ,Total_Amt = (Select Sum(Total_Amt)  from tb_SalesOrderItem where SalesOrder_Index  ='" & _SalesOrder_Index & "')"
                strSQL &= " ,VAT  = (Select Sum(Total_Amt)* 0.07  from tb_SalesOrderItem where SalesOrder_Index  ='" & _SalesOrder_Index & "') "
                strSQL &= " ,Net_Amt  =  (Select Sum(Total_Amt) + (Sum(Total_Amt)* 0.07) as Vats  from tb_SalesOrderItem where SalesOrder_Index  ='" & _SalesOrder_Index & "') "
                strSQL &= " ,Route_Index = (Select top 1 isnull(Route_Index,'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
                strSQL &= " ,SubRoute_Index  = (Select top 1 isnull(SubRoute_Index,'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
                strSQL &= " ,TransportRegion_Index = (Select top 1 isnull(TransportRegion_Index,'0010000000000')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
                'TODO : รอตัดสินใจว่ามูลค่าเท่าไหร่ถึงเป็นเงื่อนไขเปลี่ยนศูนย์กระจาย
                strSQL &= " ,DistributionCenter_Index = (select top 1 isnull(DistributionCenter_Index,'0010000000000') from ms_SubRoute where SubRoute_Index=(Select top 1 isnull(SubRoute_Index,'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index))"


                strSQL &= " Where SalesOrder_Index ='" & _SalesOrder_Index & "' "
                strSQL &= " And  Status  <> -1  "
    ...
    '            strSQL &= " ,Route_Index = (Select top 1 isnull(Route_Index,'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
    '            strSQL &= " ,SubRoute_Index  = (Select top 1 isnull(SubRoute_Index,'')  from ms_Customer_Shipping_Location where Customer_Shipping_Location_Index =tb_SalesOrder.Customer_Shipping_Location_Index)"
    '            strSQL &= " ,TransportRegion_Index = '0010000000000'"
    '            strSQL &= " ,DistributionCenter_Index = '0010000000000'"
    '' strSQL &= " ,Time_DeliveryToDestination  =  null"
    '            strSQL &= " ,Time_DocTripConfirmed  =  null"
    '            strSQL &= " ,Time_DeliveryToDestination  =  null"
    '            strSQL &= " ,Time_DocReturnedToDC  =  null"
    ...
    '            strSQL &= " Where SalesOrder_No ='" & _SalesOrder_Index & "' "
    '            strSQL &= " And  Status  <> -1  "
