        ...
        Try
            ...
            If isSave = False Then
                ...
                If CountItem > 0 Then
                    ...
                    Call New WMS_Site_TopCharoen.WithdrawTransaction(WMS_Site_TopCharoen.WithdrawTransaction.enuOperation_Type.CHECK_DATA).Withdraw_Cancel(Me.Withdraw_Index)
