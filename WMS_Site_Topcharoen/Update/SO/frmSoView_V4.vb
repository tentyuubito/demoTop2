...
#Region " BUTTON EVENTS "
    ...
    Private Sub btnConfirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
        Try
            ...
            If W_MSG_Confirm(GetMessage_Data("100048")) = Windows.Forms.DialogResult.Yes Then
                Dim drArr() As DataRow = CType(Me.grdSOView.DataSource, DataTable).Select("chkSelect=1 and Status not in (1)")
                ...
                drArr = CType(Me.grdSOView.DataSource, DataTable).Select("chkSelect=1 and Status in (1)")
                If drArr.Length > 0 Then
...
#End Region
    ...
    Private Sub btnImport_PRQ_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImport_PRQ.Click
        Try
            ...
            'Dim frm As New WMS_Site_TopCharoen.frmImport_SO_PRQ
            'Dim frm As New WMS_Site_TopCharoen.frmImport_SO_Top
            ''frm.Document_Group_Name = Document_Group_Name
            'frm.ShowDialog()

            'New for RCP
            Dim frm As New frmExcelSelect_Import
            frm.ShowDialog()
    ...
    Private Sub btnImportPRQ_txtfile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImportPRQ_txtfile.Click
        Try
            Dim frm As New WMS_Site_TopCharoen.frmImport_SO_PRQ_TextFile
            'frm.Document_Group_Name = Document_Group_Name
            frm.ShowDialog()
            Me.getSOViewSearch()
        Catch ex As Exception
